...
namespace DAL
{
    ...
    public static class cls_DAL
    {
        ...
        public static void ejecuta_sqlcommand(SqlConnection conexion, string sql, bool es_procedimiento_almacenado, ParamStruct[] parametros, ref string mensaje_error, ref int numero_error)
        {
            ...
            {
                mensaje_error = "Excepcion no controlada: " + ex2.Message;
                numero_error = 0;
            }
        }
        ...
        public static void imagen_agregar(SqlConnection conexion, string sql, string codigo, string nombre, Byte[] imagen, int id_consecutivo, string codigo_consecutivo, ref string mensaje_error, ref int numero_error)
        {
            SqlCommand sql_command;
            try
            {
                ...
                sql_command = new SqlCommand(sql, conexion);
                sql_command.CommandType = CommandType.StoredProcedure;
                sql_command.Parameters.AddWithValue("@id", id_consecutivo);
                sql_command.Parameters.AddWithValue("@cod", codigo);
                sql_command.Parameters.AddWithValue("@codigo", codigo_consecutivo);
                sql_command.Parameters.AddWithValue("@nombre", nombre);
                sql_command.Parameters.AddWithValue("@img", imagen);
                resultado = sql_command.ExecuteNonQuery();
                mensaje_error = "ok";
                numero_error = 0;
            }
        ...
        public static void imagen_modificar(SqlConnection conexion, string sql, string codigo, string nombre, Byte[] imagen, ref string mensaje_error, ref int numero_error)
        {
            SqlCommand sql_command;
            try
            {
        ...
        public static void boolean_agregar_modificar(SqlConnection conexion, string sql, int codigo, int numero, bool detalle, ref string mensaje_error, ref int numero_error)
        {
            SqlCommand sql_command;
            try
            {
                ...
                sql_command.CommandType = CommandType.StoredProcedure;
                sql_command.Parameters.AddWithValue("@cod", codigo);
                sql_command.Parameters.AddWithValue("@numero", numero);
                if (detalle)
                {

                    sql_command.Parameters.AddWithValue("@detalle", 1);
                }
                else
                {

                    sql_command.Parameters.AddWithValue("@detalle", 0);
                }
                resultado = sql_command.ExecuteNonQuery();
                mensaje_error = "ok";
                numero_error = 0;
        ...
        public static void boolean_agregar(SqlConnection conexion, string sql, string codigo, string codigo_consecutivo, int numero, bool detalle, int id, ref string mensaje_error, ref int numero_error)
        {
            SqlCommand sql_command;
            try
            {
        ...
        public static void boolean_modificar(SqlConnection conexion, string sql, string codigo, int numero, bool detalle, ref string mensaje_error, ref int numero_error)
        {
            SqlCommand sql_command;
            try
            {
